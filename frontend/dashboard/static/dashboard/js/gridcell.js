class Gridcell {
    ...
    getHtml() {
        ...
        htmlString += '</li><li class="nav-item"><a id="' + this.gridcellId + 'Graph-tab" class="nav-link active" href="#' + this.gridcellId + 'Graph" aria-controls="testGraph" role="tab" data-toggle="tab" aria-selected="false"><img class="graphTab" width="20" height="20" alt="Chart"></a></li><li class="nav-item"><a id="' + this.gridcellId + 'Settings-tab" class="nav-link" href="#' + this.gridcellId + 'Settings" aria-controls="testSettings" role="tab" data-toggle="tab" aria-selected="false"><img class="settingsTab" width="20" height="20" alt="Cogs"></a></li></ul><div id="' + this.gridcellId + 'TabContent" class="tab-content"><div id="' + this.gridcellId + 'Graph" class="tab-pane fade show active" role="tabpanel" aria-labelledby="' + this.gridcellId + 'Graph-tab"></div>';
